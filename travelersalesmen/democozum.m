...
MaxIt=100;         % Maksimum İterasyon Sayısı

nKarinca=51;        % Karınca Sayısı (Nüfus Büyüklüğü)
...
for it=1:MaxIt
    ...
    %Güncellenen Bİlgiler
    disp([ num2str(it) '.' 'Iterasyon : Elde Edilen En Kısa Yolun Maaliyeti = ' num2str(BestMaliyet(it))]);
